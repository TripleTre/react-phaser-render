...
export default abstract class Element<T, P extends JSX.DisplayObjectAsChild> {
  ...
  protected propsToInstance (props: P, propsConf: any) {
  ...
  protected isNormalPropKey (key: string) {
  ...
  protected diffProps (oldProps: P, newProps: P) {
    let updatePayload = []
